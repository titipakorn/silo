...
public class BangkokPropertiesSynPop extends AbstractPropertiesSynPop {
  ...
  public BangkokPropertiesSynPop(ResourceBundle bundle) {
    ...
    marginalsMunicipality = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle,"marginals.municipality","input/syntheticPopulation/marginalsMunicipality.csv"));
    ...
    selectedMunicipalities = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle,"municipalities.list","input/syntheticPopulation/municipalitiesList.csv"));
    selectedMunicipalities.buildIndex(selectedMunicipalities.getColumnPosition("ID_city"));

    cellsMatrix = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle,"taz.definition ","input/syntheticPopulation/zoneAttributes.csv"));
    cellsMatrix.buildIndex(cellsMatrix.getColumnPosition("ID_cell"));

    //todo this cannot be the final name of the matrix
    omxFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "distanceODmatrix", "input/syntheticPopulation/distanceMatrixQGIS.csv");
    ...
    tripLengthDistributionFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "trip.length.distribution", "input/syntheticPopulation/tripLengthDistribution.csv");
    ...
    weightsFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "weights.matrix", "microData/interimFiles/weigthsMatrix.csv");
    errorsMunicipalityFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "errors.IPU.municipality.matrix", "microData/interimFiles/errorsIPUmunicipality.csv");
    errorsCountyFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "errors.IPU.county.matrix", "microData/interimFiles/errorsIPUcounty.csv");
    errorsSummaryFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "errors.IPU.summary.matrix", "microData/interimFiles/errorsIPUsummary.csv");
    //todo do not need to ride always?
    if (runMicrolocation) {
      buildingLocationlist = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "buildingLocation.list", "input/syntheticPopulation/buildingLocation.csv"));
      jobLocationlist = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "jobLocation.list", "input/syntheticPopulation/jobLocation.csv"));
      schoolLocationlist = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "schoolLocation.list", "input/syntheticPopulation/schoolLocation.csv"));
    } else {
    ...
    zoneShapeFile = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "zones.SP.shape", "input/zonesShapefile/TAZ_wgs5.shp");
    zoneFilename = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "zones.SP.file", "input/zoneSystem.csv");

    microDataHouseholds = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "micro.data.households", "input/syntheticPopulation/hhThaiSilo.csv");
    microDataPersons = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "micro.data.persons", "input/syntheticPopulation/ppThaiSilo.csv");

    microPersonsFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "micro.persons", "microData/interimFiles/microPersons.csv");
    microHouseholdsFileName = Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "micro.households", "microData/interimFiles/microHouseholds.csv");

    incomeCoefficients = SiloUtil.readCSVfile(Properties.get().main.baseDirectory+PropertiesUtil.getStringProperty(bundle, "income.coefficients","input/syntheticPopulation/incomeCoefficients.csv"));
