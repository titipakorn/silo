...
public class PersonReaderBkk implements PersonReader {

    private final static Logger logger = Logger.getLogger(PersonReaderBkk.class);
    private final HouseholdDataManager householdDataManager;

    public PersonReaderBkk(HouseholdDataManager householdDataManager) {
    ...
    public void readData(String path) {
        ...
        try {
            ...
            while ((recString = in.readLine()) != null) {
                ...
                PersonBkk pp = (PersonBkk) ppFactory.createPerson(id, age, gender, occupation, pr, workplace, income);

                //TODO: fix hardcoded nationality
                pp.setNationality(Nationality.THAI);
