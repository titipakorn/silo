...
public class PersonBkk implements PersonWithSchool {
    ...
    private double schoolDistance = 0;

    public PersonBkk(int id, int age,
    ...
    public void setSchoolDistance(double distance) {this.schoolDistance = distance; }


    public double getSchoolDistance() {return schoolDistance;}
