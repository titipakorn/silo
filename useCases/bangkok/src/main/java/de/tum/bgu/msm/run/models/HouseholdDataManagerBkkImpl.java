 ...
 */
public class HouseholdDataManagerBkkImpl implements HouseholdDataManager {

  private final static Logger logger = Logger.getLogger(HouseholdDataManagerBkkImpl.class);

  private final HouseholdData householdData;
  private final DwellingData dwellingData;

  private final PersonFactoryBkk ppFactory;
  ...
  public HouseholdDataManagerBkkImpl(HouseholdData householdData, DwellingData dwellingData,
    ...
    this.ppFactory = new PersonFactoryBkk();
  ...
  public void endYear(int year) {
    ...
    if (!Properties.get().householdData.personIntermediatesFileName.equals("")) {
      String filepp = outputDirectory + "/" + properties.householdData.personIntermediatesFileName + "_"
        + year
        + ".csv";
      new PersonWriterBangkok(this).writePersons(filepp);
    }
  }
