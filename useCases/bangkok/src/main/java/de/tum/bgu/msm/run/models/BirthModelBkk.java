...
public class BirthModelBkk extends AbstractModel implements BirthModel {

  private final PersonFactoryBkk factory;
  private final BirthStrategy strategy;
  private final float localScaler = properties.demographics.localScaler;


  public BirthModelBkk(DataContainer dataContainer, PersonFactory factory,
                        Properties properties, BirthStrategy strategy, Random rnd) {
    super(dataContainer, properties, rnd);
    this.factory = new PersonFactoryBkk();
